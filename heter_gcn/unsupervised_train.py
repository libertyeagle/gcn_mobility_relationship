...
flags.DEFINE_float('heter_weights', 0.9, 'Weight for heterogeneous postive sampling.')
...
true_pairs_val, false_pairs_val = load_test_dataset("dataset/austin/social_relations/true_pairs_val.txt",
                          "dataset/austin/social_relations/false_pairs_val.txt")
true_pairs_test, false_pairs_test = load_test_dataset("dataset/austin/social_relations/true_pairs_test.txt",
                          "dataset/austin/social_relations/false_pairs_test.txt")
...
model = RGCN(placeholders, FLAGS.hidden1, FLAGS.emb_size, FLAGS.neg_sample_size, FLAGS.learning_rate)
...
np.save("dataset/austin/gcn_embeddings/austin_embeddings.npy", final_embeddings)
